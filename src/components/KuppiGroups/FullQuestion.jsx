...
const getCommunityQuestionFormById = async (id) => {
  const res = await fetch(`https://smart-tutor-backend-production.up.railway.app/comunityQuestions/${id}`, {
    method: "GET",
  });
...
const addAnswer = async (answers) => {
  const res = await fetch("https://smart-tutor-backend-production.up.railway.app/answers", {
    method: "POST",
    headers: {
...
const getAnswerByQuestionId = async (id) => {
  //   console.log(id)
  const res = await fetch(`https://smart-tutor-backend-production.up.railway.app/answers?questionId=${id}`, {
    method: "GET",
  });
