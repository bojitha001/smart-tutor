      ...
      <div className={styles.heroSection}>
        <div className={styles.heroContent}>
          ...
          <p className={styles.description}>
            Kuppi Groups allow students to come together for collaborative
            learning, where they can share ideas, support each other, and
          ...
          {recentTopics.map((topic) => (
            <div key={topic.id} className={styles.topicCard}>
              ...
              <div className={styles.topicContent}>
                ...
                {topic.hasImage && (
                  <div className={styles.problemImage}>
                    <img
                      src="https://raw.githubusercontent.com/your-image-url/problem.png"
                      alt="Problem"
                    />
                  </div>
                )}
              ...
              <div className={styles.topicFooter}>
                ...
                <span
                  className={`${styles.tag} ${styles[topic.tag.toLowerCase()]}`}
                >
                  {topic.tag}
                </span>
              </div>
